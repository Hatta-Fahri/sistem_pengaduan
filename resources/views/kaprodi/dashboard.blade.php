...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-polmed-blue to-blue-800 rounded-2xl p-8 shadow-lg shadow-blue-900/10 text-white relative overflow-hidden">
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <h2 class="text-2xl font-bold mb-2">Selamat Datang di Panel Kaprodi</h2>
                <p class="text-blue-100/90 text-sm md:text-base max-w-xl leading-relaxed">
                    Pantau seluruh pengaduan mahasiswa secara real-time. Anda dapat melihat statistik, mengelola data pengguna dan kategori pengaduan.
                </p>
            </div>
            <div class="flex-shrink-0">
                <a href="{{ route('kaprodi.statistik') }}" class="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-bold px-6 py-3 rounded-xl shadow-md border border-white/30 transition-all duration-200 backdrop-blur-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 012-2h0a2 2 0 012 2v6m-4 0h4m-4 0H5a1 1 0 01-1-1V9a1 1 0 011-1h0a1 1 0 011 1v9m4 0V5a1 1 0 011-1h0a1 1 0 011 1v14m4 0v-9a1 1 0 011-1h0a1 1 0 011 1v9m-4 0h4"></path></svg>
                    Lihat Statistik
                </a>
            </div>
        </div>
