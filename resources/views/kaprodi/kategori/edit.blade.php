...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
        ...
        <form method="POST" action="{{ route('kaprodi.kategori.update', $kategori) }}">
            @csrf
            @method('PUT')
            <div class="mb-5">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('kaprodi.kategori.index') }}" class="px-6 py-3 bg-white border-2 border-gray-200 hover:bg-gray-50 text-gray-600 font-bold rounded-xl text-sm transition-all">
                    Batal
                </a>
            </div>
        </form>
