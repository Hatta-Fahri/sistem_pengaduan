...
<head>
    ...
    <title>Mahasiswa Menyatakan Belum Selesai — SILPM Admin</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-bar { background: #fee2e2; border-bottom: 1px solid #fecaca; padding: 12px 40px; }
        .alert-bar p { font-size: 13px; color: #991b1b; font-weight: 600; text-align: center; }
        ...
        .alasan-box { background: #fef2f2; border: 1px solid #fecaca; border-radius: 6px; padding: 14px 18px; margin: 20px 0; }
        .alasan-box .label { font-size: 11px; font-weight: bold; color: #991b1b; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.05em; }
        .alasan-box p { font-size: 14px; color: #7f1d1d; line-height: 1.6; white-space: pre-wrap; }
